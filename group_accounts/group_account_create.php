...
<head>
    ...
    <title>Group Account Create</title>
...
<body>
    <?php include_once '../php/group_accounts/group_account_create.php' ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Group Account Create</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Group Account</li>
                    <li class="breadcrumb-item active">Group Account Create</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
    ...
    <script src="<?= $path ?>js/group_accounts/group_account_create.js"></script>
