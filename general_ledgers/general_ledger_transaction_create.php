...
<head>
    ...
    <title>General Ledger Transaction Create</title>
...
<body>
    <?php include_once '../php/general_ledgers/general_ledger_transaction_create.php' ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>General Ledger Transaction Create</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">General Ledgers</li>
                    <li class="breadcrumb-item active">General Ledger Transaction Create</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body m-4">
                            <form id="InputForm">
                                <h6 class="fw-bold fs-4">เพิ่มรายการบัญชีแยกประเภททั่วไป</h6>
                                <div class="row pb-4">
                                    <input type="hidden" class="form-control" id="general_ledger_id" name="general_ledger_id" value="<?= $_GET['general_ledger_id'] ?>" required>
                                    <div class="col-12">
                                        <div class="mb-3">
    ...
    <script src="<?= $path ?>js/general_ledgers/general_ledger_transaction_create.js"></script>
