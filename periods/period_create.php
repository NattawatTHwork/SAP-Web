...
<body>
    <?php include_once '../php/periods/period_create.php' ?>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">เพิ่มงวด</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
    ...
    <script src="<?= $path ?>js/periods/period_create.js"></script>
