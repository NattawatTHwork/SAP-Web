...
<head>
    ...
    <title>Chart Account Update</title>
...
<body>
    <?php include_once '../php/chart_accounts/chart_account_update.php' ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Chart Account Update</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Chart Account</li>
                    <li class="breadcrumb-item active">Chart Account Update</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="card">
                        <div class="card-body m-4">
                            ...
                            <form id="chart_accountForm">
                                <input type="hidden" id="chart_account_id" name="chart_account_id" value="" required>
    ...
    <script src="<?= $path ?>js/chart_accounts/chart_account_update.js"></script>
