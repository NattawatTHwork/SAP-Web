...
<body>
    <?php include_once '../php/document_types/document_type_create.php' ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>เพิ่มประเภทเอกสาร</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a></li>
                    <li class="breadcrumb-item">ประเภทเอกสาร</li>
                    <li class="breadcrumb-item active">เพิ่มประเภทเอกสาร</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
    ...
    <script src="<?= $path ?>js/document_types/document_type_create.js"></script>
