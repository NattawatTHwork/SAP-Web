...
<head>
    ...
    <title>Period Group Detail</title>
...
<body>
    <?php include_once '../php/period_groups/period_group_detail.php' ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Period Group Detail</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Period Group</li>
                    <li class="breadcrumb-item active">Period Group Detail</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
    ...
    <script src="<?= $path ?>js/period_groups/period_group_detail.js"></script>
