...
<body>
    <?php include_once '../php/currencies/currency_update.php' ?>
        ...
        <div class="pagetitle">
            ...
            <nav>
                ...
                <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a></li>
                    ...
                    <li class="breadcrumb-item active">แก้ไขสกุลเงิน</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
    ...
    <script src="<?= $path ?>js/currencies/currency_update.js"></script>
