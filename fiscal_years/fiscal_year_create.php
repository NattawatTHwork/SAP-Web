...
<head>
    ...
    <title>เพิ่มชุดการเลือกปีบัญชี</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>เพิ่มชุดการเลือกปีบัญชี</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a></li>
                    <li class="breadcrumb-item">ชุดการเลือกปีบัญชี</li>
                    <li class="breadcrumb-item active">เพิ่มชุดการเลือกปีบัญชี</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body m-4">
                            ...
                            <form id="InputForm">
                                <h6 class="fw-bold fs-4">สร้างชุดการเลือกปีบัญชี</h6>
                                <div class="row pb-4">
                                    <div class="col-12">
                                        <div class="mb-3">
