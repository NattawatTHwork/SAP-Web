...
<body>
    <?php include_once '../php/branch_numbers/branch_number_update.php' ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>แก้ไขเลขที่สาขา</h1>
            <nav>
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a></li>
                    <li class="breadcrumb-item">เลขที่สาขา</li>
                    <li class="breadcrumb-item active">แก้ไขเลขที่สาขา</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body m-4">
                            ...
                            <form id="InputForm">
                                <input type="hidden" id="branch_number_id" name="branch_number_id" value="">
    ...
    <script src="<?= $path ?>js/branch_numbers/branch_number_update.js"></script>
