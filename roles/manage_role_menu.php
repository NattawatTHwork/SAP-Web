...
<body>
    <?php include_once '../php/roles/manage_role_menu.php' ?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body m-4">
                            ...
                            <form id="InputForm">
                                <h6 class="fw-bold fs-4">เพิ่มสิทธิ์</h6>
                                <input type="hidden" class="form-control" id="role_id" name="role_id" value="<?= $_GET['role_id'] ?>" required>
    ...
    <script src="<?= $path ?>js/roles/manage_role_menu.js"></script>
