...
<body>
    <?php include_once '../php/transaction_periods/transaction_period_create.php' ?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body m-4">
                            ...
                            <form id="InputForm">
                                <h6 class="fw-bold fs-4">เพิ่มงวดการผ่านบัญชี</h6>
                                <div class="row pb-4">
                                    <div class="col-12">
                                        <div class="mb-3">
    ...
    <script src="<?= $path ?>js/transaction_periods/transaction_period_create.js"></script>
