...
<body>
    <?php include_once '../php/transaction_period_groups/transaction_period_group_update.php' ?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body m-4">
                            ...
                            <form id="InputForm">
                                <h6 class="fw-bold fs-4"><?= $texts['transaction_period_group_update'] ?></h6>
                                <div class="row pb-4">
                                    <input type="hidden" class="form-control" id="transaction_period_group_id" name="transaction_period_group_id" required>
                                    <div class="col-12">
                                        <div class="mb-3">
    ...
    <script src="<?= $path ?>js/transaction_period_groups/transaction_period_group_update.js"></script>
